...
public class PIDConstants {
    ...
    public PIDConstants(final double kP) {
        this(kP, 0, 0, 0, 0, 0);
    }

    public PIDConstants(final double kV, final double kA) {
        this(0, 0, 0, 0, kV, kA);
    }

    public PIDConstants(final double kP, final double kI, final double kD) {
        this(kP, kI, kD, 0, 0, 0);
    }

    public PIDConstants(final double kP, final double kI, final double kD, final double kS) {
    ...
    public PIDConstants(PIDConstants controlConstants) {
